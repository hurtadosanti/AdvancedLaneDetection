...
class LaneFinder:
    ...
    def find_lanes_windows(self, image, number_windows: int = 9, margin: int = 100, min_pixels: int = 50):
    ...
    def plot_polylines(self, image):
        # Find Lane sections
        left_x, left_y, right_x, right_y = self.find_lanes_windows(image)
        ...
        return res, plot_y, left_fit_x, right_fit_x, left_fit, right_fit
    ...
    def search_around_polylines(self, image, margin=100):
        ...
        # Fit new polynomials
        plot_y = np.linspace(0, image.shape[0] - 1, image.shape[0])
        left_fit_x, right_fit_x = self.fit_poly(plot_y,
    ...
    def fit_poly(self, plot_y, left_x, left_y, right_x, right_y):
